...
define('MODULE_PAYMENT_QUICKPAY_ADVANCED_MASTERCARD_DEBET_DK_3D_TEXT', 'Mastercard Debit 3D-Secure (Dansk)');
...
define('MODULE_PAYMENT_QUICKPAY_ADVANCED_MOBILEPAY_TEXT', 'Mobilepay');
...
define('MODULE_PAYMENT_QUICKPAY_ADVANCED_VIPPSPSP_TEXT', 'Vipps via Quickpay');
define('MODULE_PAYMENT_QUICKPAY_ADVANCED_APPLE_PAY_TEXT', 'Apple Pay');
define('MODULE_PAYMENT_QUICKPAY_ADVANCED_GOOGLE_PAY_TEXT', 'Google Pay');
...
// define('MODULE_PAYMENT_QUICKPAY_ADVANCED_IBILL_TEXT', 'ViaBill');
?>
